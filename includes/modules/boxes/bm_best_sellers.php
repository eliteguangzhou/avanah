...
/* ********************************* */			 
			$name_prod = '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '">' . $best_sellers['products_name'] . '</a>';
...
/* ********************************* */				
       ...
       //   $bestsellers_list .= '';
          ...
          $data = '<div class="infoBoxWrapper list">' . tep_draw_box_wrapper_top() . 
                  '  <div class="infoBoxHeading">' . tep_draw_box_title_top() . MODULE_BOXES_BEST_SELLERS_BOX_TITLE . tep_draw_box_title_bottom() . '</div>' .
                  '  <div class="infoBoxContents">' . tep_draw_box_content_top() . '<ul class="bestsellers">' . $bestsellers_list . '</ul>' . tep_draw_box_content_bottom() . '</div>' .
